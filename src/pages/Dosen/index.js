...
export default function Dosen({ navigation }) {
    ...
    const getTransaction = () => {
        axios.post(apiURL + 'dosen').then(res => {
        ...
        return (
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('DosenEdit', item)}>
                    ...
                    <TouchableOpacity onPress={() => Alert.alert(MYAPP, 'Apakah kamu yakin akan hapus ini ?', [
                        ...
                        },
                        {
                            ...
                            onPress: () => {
                                ...
                                console.log(item.id);
                                axios.post(apiURL + 'dosen_delete', {
                                    id: item.id
                                }).then(res => {
                                    console.log(res.data);
                                    getTransaction();
