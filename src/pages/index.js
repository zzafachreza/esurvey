...
import TimAdd from './TimAdd';
import TimDetail from './TimDetail';
import TimList from './TimList';
import TimAddPemain from './TimAddPemain';
...
import KelasAdd from './KelasAdd';
import KelasEdit from './KelasEdit';
import Matakuliah from './Matakuliah';
import MatakuliahAdd from './MatakuliahAdd';
import MatakuliahEdit from './MatakuliahEdit';
import Dosen from './Dosen';
import DosenAdd from './DosenAdd';
import DosenEdit from './DosenEdit';
import Kuesioner from './Kuesioner';
import KuesionerAdd from './KuesionerAdd';
import KuesionerEdit from './KuesionerEdit';
