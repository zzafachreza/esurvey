...
export default function Router() {
  return (
    <Stack.Navigator>
        ...
        options={({ route, navigation }) => ({
          ...
          headerRight: () => (
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('KelasAdd')}
                style={{
                  position: 'relative',
                  padding: 5,
                  marginHorizontal: 5,
        ...
        options={({ route, navigation }) => ({
          ...
          headerRight: () => (
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('MatakuliahAdd')}
                style={{
                  position: 'relative',
                  padding: 5,
                  marginHorizontal: 5,
        ...
        options={({ route, navigation }) => ({
          ...
          headerRight: () => (
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('DosenAdd')}
                style={{
                  position: 'relative',
                  padding: 5,
                  marginHorizontal: 5,
        ...
        options={({ route, navigation }) => ({
          ...
          headerRight: () => (
            <View
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate('KuesionerAdd')}
                style={{
                  position: 'relative',
                  padding: 5,
                  marginHorizontal: 5,
      ...
      <Stack.Screen
        name="KuesionerAdd"
        component={KuesionerAdd}
        options={{
          headerShown: true,
          headerTitle: 'Tambah Kuesioner',
          headerStyle: {
            backgroundColor: colors.primary,
          },
          headerTintColor: '#fff',
      ...
      <Stack.Screen
        ...
        options={{
          headerShown: true,
          headerTitle: 'Cetak Hasil E - SURVEY',
          headerStyle: {
            backgroundColor: colors.primary,
          },
          headerTintColor: '#fff',
